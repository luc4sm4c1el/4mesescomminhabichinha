...
$(document).ready(function(){
    ...
    const mostraMsgMes = (texto) =>{
        ...
        switch(texto){
            case "17/12": titulo = "17 de Dezembro de 2022"; mensagem = "<p>Nosso primeiro beijo, foram tantas emoções esse dia vou te contar hein KKKK ❤️</p>";break;
            case "31/12": titulo = "31 de Dezembro de 2022"; mensagem = "<p>Primeiro pedido de namoro não oficial.<br><p>Depois de lhe vê naquele dia, eu tinha certeza que queria fazer mini Vitorinhas e mini Luquinhas com você</p>";break;
